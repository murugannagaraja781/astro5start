                ...
                btnChart.setOnClickListener {
                    try {
                        if (clientBirthData != null) {
                            val intent = Intent(this, com.astroluna.app.ui.chart.ChartDisplayActivity::class.java)
                ...
                btnMatch.setOnClickListener {
                    try {
                        if (clientBirthData != null && clientBirthData!!.has("partner")) {
                             val intent = Intent(this, com.astroluna.app.ui.chart.MatchDisplayActivity::class.java)
                             intent.putExtra("birthData", clientBirthData.toString())
                             startActivity(intent)
                        } else {
