# MongoDB Backup Setup Walkthrough (Astro5Star)

I have created a backup script for you at `/Users/wohozo/Documents/astro5start/scripts/db_backup.sh`. This script will:
...
`0 2 * * * /Users/wohozo/Documents/astro5start/scripts/db_backup.sh >> /Users/wohozo/Documents/astro5start/backups/backup.log 2>&1`

### 4. Test it now
You can run it manually right away to see if it works:
`/Users/wohozo/Documents/astro5start/scripts/db_backup.sh`
